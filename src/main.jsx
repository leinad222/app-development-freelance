...
const products = [
    ['Mac', 'From $799', 'product-mac', '⌘', 'MacBook Air', 'https://images.unsplash.com/photo-1517336714731-489689fd1ca8?auto=format&fit=crop&w=900&q=85'],
    ['iPhone', 'From $599', 'product-phone', '●', 'iPhone 17', 'https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?auto=format&fit=crop&w=900&q=85'],
    ['iPad', 'From $519', 'product-ipad', '▣', 'iPad Air', 'https://images.unsplash.com/photo-1544244015-0df4b3ffc6b0?auto=format&fit=crop&w=900&q=85'],
    ['Watch', 'From $299', 'product-watch', '◉', 'Apple Watch Series 11', 'https://images.unsplash.com/photo-1546868871-7041f2a55e12?auto=format&fit=crop&w=900&q=85'],
    ['AirPods', 'From $149', 'product-airpods', '◌', 'AirPods Pro', 'https://images.unsplash.com/photo-1606220945770-b5b6c2c55bf1?auto=format&fit=crop&w=900&q=85'],
];
